...
public class VScoreboard {
	...
	for (UnmodifiableIterator<String> unmodifiableIterator = ImmutableSet.copyOf(displayedScores.keySet())
		.iterator(); unmodifiableIterator.hasNext();) {
	    final String displayedScore = unmodifiableIterator.next();
