...
public class QuestManager {
    ...
    HashMap<String, Quester> questers = Maps.newHashMap();
    HashMap<String, Quest> quests = Maps.newHashMap();
    HashMap<UUID, List<String>> takenQuests = Maps.newHashMap(), completedQuests = Maps.newHashMap();
